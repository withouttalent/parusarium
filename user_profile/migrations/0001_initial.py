# Generated by Django 2.1.2 on 2018-10-22 11:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allowed_region', models.CharField(blank=True, max_length=120, null=True)),
                ('allowed_site', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.CharField(blank=True, max_length=380, null=True, verbose_name='Файл')),
                ('count_files', models.IntegerField(blank=True, null=True, verbose_name='Кол-во файлов')),
                ...
                ('date_expired', models.DateTimeField(blank=True, null=True, verbose_name='Дата удаления')),
